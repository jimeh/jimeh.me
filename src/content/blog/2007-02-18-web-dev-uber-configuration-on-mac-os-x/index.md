...
[http://www.entropy.ch/software/macosx/php/](http://www.entropy.ch/software/macosx/php/)
...
[http://mysql.org/downloads/mysql/5.0.html#Mac_OS_X\_(package_format)](<http://mysql.org/downloads/mysql/5.0.html#Mac_OS_X_(package_format)>)
...
[http://mysql.org/downloads/gui-tools/5.0.html#OSX](http://mysql.org/downloads/gui-tools/5.0.html#OSX)
...
open [http://banjo/](http://banjo/) in a web browser, and I’m all set to create
another world dominating merciless enemy business killing machine of a site...
Heh

Myself I've got [phpMyAdmin](http://www.phpmyadmin.net/) installed in
`~/Sites/_public/mysql/`, which makes it accessible at
[http://localhost/mysql/](http://localhost/mysql/). Also, I have a virtual host
configured, and a entry in the hosts file so I can also access from
...
quickly open using [Quicksilver](http://quicksilver.blacktree.com) by pressing
cmd+space and typing `httpd` and pressing return cause the project file is
called `httpd`. But the rest of my workflow is a story for another time ;)
