...
description:
  ...
  for some :)"
date: 2006-12-16
slug: code-yard-updates
archive: zhuoqe.org
tags: ["development", "php"]
---

I just updated and added a few PHP scripts to
[Code Yard](dead+http://zhuoqe.org/svn/codeyard/trunk/) that might be useful for
some :)

- Updated and fixed some bugs in [`parseCSV`](dead+missing://parsecsv) and
  [`parseINI`](dead+missing://parseini).

- [`speedometer{}`](dead+missing://speedometer) — Class for simplifying
  calculation of script execution time.

- [`walkDir{}`](dead+missing://walkdir) — Class for recursively getting a list
  of directory contents. It returns both a multi-dimentional array, and a plain
...
- [`rfile()`](dead+missing://rfile) & [`wfile()`](dead+missing://wfile) —
...
- [`randpass()`](dead+missing://randpass) — Function with a quite
