...
date: 2010-02-05
slug: new-avatar-same-old-fugly-face
tags: ["social-media", "life", "avatar"]
archive: true
image:
  src: ./jimeh-2.0.jpg
  hidden: true
...
import v1 from "./jimeh-1.0.jpg";
import v2 from "./jimeh-2.0.jpg";
...
<ImageGrid columns={2} size="60%">
  <Image src={v1} caption="jimeh 1.0" />
  <Image src={v2} caption="jimeh 2.0" />
</ImageGrid>

And in case you're wondering, I'm 18 or 19 in the old photo, and 24 in the new
