...
<ImageGrid columns={2} size="wide">
  <Figure src={website1} alt="Website 1" caption="v1.0" />
  <Figure src={website2} alt="Website 2" caption="v2.0" />
  <Figure src={website3} alt="Website 3" caption="v3.0" />
  <Figure src={website4} alt="Website 4" caption="v4.0" />
</ImageGrid>
