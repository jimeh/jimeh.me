...
is [`parseCSV{}`](http://zhuoqe.org/svn/codeyard/trunk/php/classes/parseCSV/)...
lol

Obviously having major hard drive problems haven't helped :P

Anyway, i spent the most part of today updating
[`parseCSV{}`](http://zhuoqe.org/svn/codeyard/trunk/php/classes/parseCSV/),
